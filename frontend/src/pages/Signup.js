...
// // import { Brain, Eye, EyeOff, Shield, User, Mail } from 'lucide-react';
...
// //             Create your account and start your emotional wellness journey
// //           </p>
...
// //             <Link 
// //               to="/login"
// //               className="flex-1 py-3 px-4 text-center font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors rounded-l-xl"
// //             >
// //               Login
// //             </Link>
// //             <button className="flex-1 py-3 px-4 text-center font-semibold bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-r-xl">
// //               Sign Up
// //             </button>
// //           </div>
...
// export default Signup;
// Signup.js - Complete Enhanced Version with Validation
import React, { useState } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { useAuth } from '../context/AuthContext';
import LoadingSpinner from '../components/ui/LoadingSpinner';
import { Brain, Eye, EyeOff, Shield, User, Mail, AlertCircle, CheckCircle } from 'lucide-react';
...
const Signup = () => {
  ...
  const getPasswordStrength = (password) => {
    ...
    if (score < 4) return { strength: 'Fair', color: 'yellow', width: '50%' };
    if (score < 5) return { strength: 'Good', color: 'blue', width: '75%' };
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="text"
                  required
                  className={`pl-12 pr-10 ${getFieldClassName('username')}`}
                  placeholder="Enter your full name"
                  value={formData.username}
                  onChange={handleChange}
                  onBlur={handleBlur}
              ...
              {formData.password && touched.password && (
                <div className="mt-2">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className={`text-sm font-medium text-${getPasswordStrength(formData.password).color}-600`}>
                      {getPasswordStrength(formData.password).strength}
                    </span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
                      className={`bg-${getPasswordStrength(formData.password).color}-600 h-2 rounded-full transition-all`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type={showConfirmPassword ? 'text' : 'password'}
                  required
                  className={`pl-12 pr-20 ${getFieldClassName('confirmPassword')}`}
                  placeholder="Confirm your password"
                  value={formData.confirmPassword}
                  onChange={handleChange}
                  onBlur={handleBlur}
